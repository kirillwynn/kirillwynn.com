...
| M05 | Review pending | Repository, Package, and Logical Runtime Topology. |

M01, M01-R1, M01-R2, M02, M02-A1, M03, M03-A1, M04, and M04-A1 are Accepted. M05 is Review pending. M06-M14 remain Planned and unauthorized, and all directional containers remain Planned and non-authorizable.
